...
$(document).ready(function() {
	...
	// function to remove items from the basket pos[0]
	...
	// function to remove items from the basket pos[1]
	document.getElementById("remove_2").onclick = function()
	{
		//pop arrays from storage
		var prodIdArr = JSON.parse(sessionStorage["prodIdArr"]);
		var quantityArr = JSON.parse(sessionStorage["quantityArr"]);
	...
	// function to remove items from the basket pos[2]
	...
	// function to remove items from the basket pos[3]
	...
	// function to remove items from the basket pos[4]
	...
	// function to remove items from the basket pos[5]
	...
	// function to remove items from the basket pos[6]
	...
	// function to remove items from the basket pos[7]
	...
	// function to remove items from the basket pos[8]
	...
	// function to remove items from the basket pos[9]
	...
	// function to remove items from the basket pos[10]
	...
	// function to remove items from the basket pos[11]
	...
	// function to remove items from the basket pos[12]
	...
	// function to remove items from the basket pos[13]
	document.getElementById("remove_14").onclick = function()
	{
		//pop arrays from storage
		var prodIdArr = JSON.parse(sessionStorage["prodIdArr"]);
		var quantityArr = JSON.parse(sessionStorage["quantityArr"]);
		
		// Removes the 13th element of prodIdArr
		prodIdArr.splice(13, 1);
		// Removes the 12th element of quantityArr        
		quantityArr.splice(13, 1);		
		//send arrays to storage
		sessionStorage["prodIdArr"] = JSON.stringify(prodIdArr);
		sessionStorage["quantityArr"] = JSON.stringify(quantityArr);
		//refresh page
	...
	// function to remove items from the basket pos[14]
	document.getElementById("remove_15").onclick = function()
	{
		//pop arrays from storage
		var prodIdArr = JSON.parse(sessionStorage["prodIdArr"]);
		var quantityArr = JSON.parse(sessionStorage["quantityArr"]);
		
		// Removes the 14th element of prodIdArr
		prodIdArr.splice(14, 1);
		// Removes the 14th element of quantityArr        
		quantityArr.splice(14, 1);		
		//send arrays to storage
		sessionStorage["prodIdArr"] = JSON.stringify(prodIdArr);
		sessionStorage["quantityArr"] = JSON.stringify(quantityArr);
		//refresh page
